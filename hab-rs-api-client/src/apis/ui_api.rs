...
pub trait UiApi: Send + Sync {
    ...
    ///
    /// 
    async fn add_ui_component_to_namespace<'namespace, 'root_ui_component>(&self, namespace: &'namespace str, root_ui_component: Option<models::RootUiComponent>) -> Result<models::RootUiComponent, Error<AddUiComponentToNamespaceError>>;

    /// GET /ui/components/{namespace}
    ///
    /// 
    async fn get_registered_ui_components_in_namespace<'namespace, 'summary>(&self, namespace: &'namespace str, summary: Option<bool>) -> Result<Vec<models::RootUiComponent>, Error<GetRegisteredUiComponentsInNamespaceError>>;

    /// GET /ui/components/{namespace}/{componentUID}
    ///
    /// 
    async fn get_ui_component_in_namespace<'namespace, 'component_uid>(&self, namespace: &'namespace str, component_uid: &'component_uid str) -> Result<models::RootUiComponent, Error<GetUiComponentInNamespaceError>>;
    ...
    ///
    /// 
    async fn remove_ui_component_from_namespace<'namespace, 'component_uid>(&self, namespace: &'namespace str, component_uid: &'component_uid str) -> Result<(), Error<RemoveUiComponentFromNamespaceError>>;

    /// PUT /ui/components/{namespace}/{componentUID}
    ///
    /// 
    async fn update_ui_component_in_namespace<'namespace, 'component_uid, 'root_ui_component>(&self, namespace: &'namespace str, component_uid: &'component_uid str, root_ui_component: Option<models::RootUiComponent>) -> Result<models::RootUiComponent, Error<UpdateUiComponentInNamespaceError>>;
}
...
impl UiApi for UiApiClient {
    async fn add_ui_component_to_namespace<'namespace, 'root_ui_component>(&self, namespace: &'namespace str, root_ui_component: Option<models::RootUiComponent>) -> Result<models::RootUiComponent, Error<AddUiComponentToNamespaceError>> {
        ...
        let local_var_uri_str = format!("{}/ui/components/{namespace}", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace));
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AddUiComponentToNamespaceError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn get_registered_ui_components_in_namespace<'namespace, 'summary>(&self, namespace: &'namespace str, summary: Option<bool>) -> Result<Vec<models::RootUiComponent>, Error<GetRegisteredUiComponentsInNamespaceError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetRegisteredUiComponentsInNamespaceError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_ui_component_in_namespace<'namespace, 'component_uid>(&self, namespace: &'namespace str, component_uid: &'component_uid str) -> Result<models::RootUiComponent, Error<GetUiComponentInNamespaceError>> {
        ...
        let local_var_uri_str = format!("{}/ui/components/{namespace}/{componentUID}", local_var_configuration.base_path, namespace=crate::apis::urlencode(namespace), componentUID=crate::apis::urlencode(component_uid));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetUiComponentInNamespaceError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_ui_tiles<>(&self, ) -> Result<Vec<models::TileDto>, Error<GetUiTilesError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetUiTilesError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn remove_ui_component_from_namespace<'namespace, 'component_uid>(&self, namespace: &'namespace str, component_uid: &'component_uid str) -> Result<(), Error<RemoveUiComponentFromNamespaceError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<RemoveUiComponentFromNamespaceError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn update_ui_component_in_namespace<'namespace, 'component_uid, 'root_ui_component>(&self, namespace: &'namespace str, component_uid: &'component_uid str, root_ui_component: Option<models::RootUiComponent>) -> Result<models::RootUiComponent, Error<UpdateUiComponentInNamespaceError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateUiComponentInNamespaceError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
