...
pub trait AuthApi: Send + Sync {
    ...
    ///
    /// 
    async fn delete_session<'id, 'refresh_token>(&self, id: Option<&'id str>, refresh_token: Option<&'refresh_token str>) -> Result<(), Error<DeleteSessionError>>;

    /// GET /auth/apitokens
    ///
    /// 
    async fn get_api_tokens<>(&self, ) -> Result<Vec<models::UserApiTokenDto>, Error<GetApiTokensError>>;

    /// POST /auth/token
    ///
    /// 
    async fn get_o_auth_token<'use_cookie, 'client_id, 'code, 'code_verifier, 'grant_type, 'redirect_uri, 'refresh_token>(&self, use_cookie: Option<bool>, client_id: Option<&'client_id str>, code: Option<&'code str>, code_verifier: Option<&'code_verifier str>, grant_type: Option<&'grant_type str>, redirect_uri: Option<&'redirect_uri str>, refresh_token: Option<&'refresh_token str>) -> Result<models::TokenResponseDto, Error<GetOAuthTokenError>>;

    /// GET /auth/sessions
    ///
    /// 
    async fn get_sessions_for_current_user<>(&self, ) -> Result<Vec<models::UserSessionDto>, Error<GetSessionsForCurrentUserError>>;

    /// DELETE /auth/apitokens/{name}
    ///
    /// 
    async fn remove_api_token<'name>(&self, name: &'name str) -> Result<(), Error<RemoveApiTokenError>>;
}
...
impl AuthApi for AuthApiClient {
    ...
    async fn get_api_tokens<>(&self, ) -> Result<Vec<models::UserApiTokenDto>, Error<GetApiTokensError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetApiTokensError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_o_auth_token<'use_cookie, 'client_id, 'code, 'code_verifier, 'grant_type, 'redirect_uri, 'refresh_token>(&self, use_cookie: Option<bool>, client_id: Option<&'client_id str>, code: Option<&'code str>, code_verifier: Option<&'code_verifier str>, grant_type: Option<&'grant_type str>, redirect_uri: Option<&'redirect_uri str>, refresh_token: Option<&'refresh_token str>) -> Result<models::TokenResponseDto, Error<GetOAuthTokenError>> {
        ...
        if let Some(ref local_var_str) = use_cookie {
            local_var_req_builder = local_var_req_builder.query(&[("useCookie", &local_var_str.to_string())]);
        }
        if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
            local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
        }
    ...
    async fn get_sessions_for_current_user<>(&self, ) -> Result<Vec<models::UserSessionDto>, Error<GetSessionsForCurrentUserError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetSessionsForCurrentUserError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn remove_api_token<'name>(&self, name: &'name str) -> Result<(), Error<RemoveApiTokenError>> {
        ...
        let local_var_uri_str = format!("{}/auth/apitokens/{name}", local_var_configuration.base_path, name=crate::apis::urlencode(name));
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<RemoveApiTokenError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
