...
pub trait AddonsApi: Send + Sync {
    ...
    ///
    ///
    async fn get_addon_by_id<'addon_id, 'accept_language, 'service_id>(
        &self,
        addon_id: &'addon_id str,
        accept_language: Option<&'accept_language str>,
        service_id: Option<&'service_id str>,
    ) -> Result<models::Addon, Error<GetAddonByIdError>>;

    /// GET /addons/{addonId}/config
    ///
    ///
    async fn get_addon_configuration<'addon_id, 'service_id>(
        &self,
        addon_id: &'addon_id str,
        service_id: Option<&'service_id str>,
    ) -> Result<String, Error<GetAddonConfigurationError>>;

    /// GET /addons/types
    ///
    ///
    async fn get_addon_services<'accept_language, 'service_id>(
        &self,
        accept_language: Option<&'accept_language str>,
        service_id: Option<&'service_id str>,
    ) -> Result<Vec<models::AddonType>, Error<GetAddonServicesError>>;

    /// GET /addons/services
    ///
    ///
    async fn get_addon_types<'accept_language>(
        &self,
        accept_language: Option<&'accept_language str>,
    ) -> Result<Vec<models::AddonType>, Error<GetAddonTypesError>>;

    /// GET /addons
    ///
    ///
    async fn get_addons<'accept_language, 'service_id>(
        &self,
        accept_language: Option<&'accept_language str>,
        service_id: Option<&'service_id str>,
    ) -> Result<Vec<models::Addon>, Error<GetAddonsError>>;

    /// GET /addons/suggestions
    ///
    ///
    async fn get_suggested_addons<'accept_language>(
        &self,
        accept_language: Option<&'accept_language str>,
    ) -> Result<Vec<models::Addon>, Error<GetSuggestedAddonsError>>;

    /// POST /addons/{addonId}/install
    ///
    ///
    async fn install_addon_by_id<'addon_id, 'service_id>(
        &self,
        addon_id: &'addon_id str,
        service_id: Option<&'service_id str>,
    ) -> Result<(), Error<InstallAddonByIdError>>;

    /// POST /addons/url/{url}/install
    ///
    ///
    async fn install_addon_from_url<'url>(
        &self,
        url: &'url str,
    ) -> Result<(), Error<InstallAddonFromUrlError>>;

    /// POST /addons/{addonId}/uninstall
    ///
    ///
    async fn uninstall_addon<'addon_id, 'service_id>(
        &self,
        addon_id: &'addon_id str,
        service_id: Option<&'service_id str>,
    ) -> Result<(), Error<UninstallAddonError>>;

    /// PUT /addons/{addonId}/config
    ///
    ///
    async fn update_addon_configuration<'addon_id, 'service_id, 'request_body>(
        &self,
        addon_id: &'addon_id str,
        service_id: Option<&'service_id str>,
        request_body: Option<std::collections::HashMap<String, serde_json::Value>>,
    ) -> Result<String, Error<UpdateAddonConfigurationError>>;
}
...
impl AddonsApi for AddonsApiClient {
    async fn get_addon_by_id<'addon_id, 'accept_language, 'service_id>(
        ...
        let local_var_uri_str = format!(
            ...
            addonId = crate::apis::urlencode(addon_id)
        );
            ...
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::Addon`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::Addon`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<GetAddonByIdError> =
    ...
    async fn get_addon_configuration<'addon_id, 'service_id>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetAddonConfigurationError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_addon_services<'accept_language, 'service_id>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `Vec&lt;models::AddonType&gt;`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `Vec&lt;models::AddonType&gt;`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<GetAddonServicesError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_addon_types<'accept_language>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetAddonTypesError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_addons<'accept_language, 'service_id>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `Vec&lt;models::Addon&gt;`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `Vec&lt;models::Addon&gt;`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<GetAddonsError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_suggested_addons<'accept_language>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetSuggestedAddonsError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn install_addon_by_id<'addon_id, 'service_id>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<InstallAddonByIdError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn install_addon_from_url<'url>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<InstallAddonFromUrlError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn uninstall_addon<'addon_id, 'service_id>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UninstallAddonError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn update_addon_configuration<'addon_id, 'service_id, 'request_body>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateAddonConfigurationError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
