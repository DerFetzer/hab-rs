...
pub trait TransformationsApi: Send + Sync {
    ...
    ///
    /// 
    async fn delete_transformation<'uid>(&self, uid: &'uid str) -> Result<(), Error<DeleteTransformationError>>;

    /// GET /transformations/{uid}
    ///
    /// 
    async fn get_transformation<'uid>(&self, uid: &'uid str) -> Result<models::Transformation, Error<GetTransformationError>>;

    /// GET /transformations/services
    ///
    /// 
    async fn get_transformation_services<>(&self, ) -> Result<Vec<String>, Error<GetTransformationServicesError>>;

    /// GET /transformations
    ///
    /// 
    async fn get_transformations<>(&self, ) -> Result<Vec<models::TransformationDto>, Error<GetTransformationsError>>;

    /// PUT /transformations/{uid}
    ///
    /// 
    async fn put_transformation<'uid, 'transformation_dto>(&self, uid: &'uid str, transformation_dto: models::TransformationDto) -> Result<(), Error<PutTransformationError>>;
}
...
impl TransformationsApi for TransformationsApiClient {
    async fn delete_transformation<'uid>(&self, uid: &'uid str) -> Result<(), Error<DeleteTransformationError>> {
        ...
        let local_var_uri_str = format!("{}/transformations/{uid}", local_var_configuration.base_path, uid=crate::apis::urlencode(uid));
    ...
    async fn get_transformation<'uid>(&self, uid: &'uid str) -> Result<models::Transformation, Error<GetTransformationError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetTransformationError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_transformation_services<>(&self, ) -> Result<Vec<String>, Error<GetTransformationServicesError>> {
        ...
        let local_var_uri_str = format!("{}/transformations/services", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetTransformationServicesError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_transformations<>(&self, ) -> Result<Vec<models::TransformationDto>, Error<GetTransformationsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetTransformationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn put_transformation<'uid, 'transformation_dto>(&self, uid: &'uid str, transformation_dto: models::TransformationDto) -> Result<(), Error<PutTransformationError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<PutTransformationError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
